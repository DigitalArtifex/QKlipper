...
QKlipperMCU::QKlipperMCU(const QKlipperMCU &value)
{
    m_baudRate = value.m_baudRate;
    m_sequenceRecieved = value.m_sequenceRecieved;
    m_sequenceSent = value.m_sequenceSent;
    m_sequenceRetransmitted = value.m_sequenceRetransmitted;
    m_bytesInvalid = value.m_bytesInvalid;
    m_bytesRead = value.m_bytesRead;
    m_bytesRetransmitted = value.m_bytesRetransmitted;
    m_bytesWritten = value.m_bytesWritten;
    m_bytesUpcoming = value.m_bytesUpcoming;
    m_bytesAvailable = value.m_bytesAvailable;
    m_frequency = value.m_frequency;

    m_serial = value.m_serial;
    m_firmwareVersion = value.m_firmwareVersion;
    m_hardwareVersion = value.m_hardwareVersion;

    m_awake = value.m_awake;
    m_taskAverage = value.m_taskAverage;
    m_devAverage = value.m_devAverage;
    m_maxStepperError = value.m_maxStepperError;
}

QKlipperMCU::QKlipperMCU(QKlipperMCU &&value)
{
    m_baudRate = value.m_baudRate;
    m_sequenceRecieved = value.m_sequenceRecieved;
    m_sequenceSent = value.m_sequenceSent;
...
QKlipperMCU &QKlipperMCU::operator=(const QKlipperMCU &value)
{
    m_baudRate = value.m_baudRate;
    m_sequenceRecieved = value.m_sequenceRecieved;
    m_sequenceSent = value.m_sequenceSent;
...
QKlipperMCU &QKlipperMCU::operator=(QKlipperMCU &&value)
{
    m_baudRate = value.m_baudRate;
    m_sequenceRecieved = value.m_sequenceRecieved;
    m_sequenceSent = value.m_sequenceSent;
...
bool QKlipperMCU::operator==(QKlipperMCU &&value)
{
    if(m_baudRate != value.m_baudRate) return false;
    if(m_sequenceRecieved != value.m_sequenceRecieved) return false;
    if(m_sequenceSent != value.m_sequenceSent) return false;
...
bool QKlipperMCU::operator!=(const QKlipperMCU &value)
{
    if(m_baudRate == value.m_baudRate &&
        m_sequenceRecieved == value.m_sequenceRecieved &&
        m_sequenceSent == value.m_sequenceSent &&
        m_sequenceRetransmitted == value.m_sequenceRetransmitted &&
        m_bytesInvalid == value.m_bytesInvalid &&
